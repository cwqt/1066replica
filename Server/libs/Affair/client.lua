...
local User = require("../libs/Affair/user" )
local CMD = require("../libs/Affair/commands" )

local utility = require("../libs/Affair/utility" )
...
function Client:new( address, port, localPort, playerName, authMsg )
	local o = {}
	setmetatable( o, self )
